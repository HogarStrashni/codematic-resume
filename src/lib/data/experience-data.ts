...
export const experienceData = [
	...
	},
	{
		...
		technologies: [
			'Frontend development using React JS / Vite / TypeScript',
			...
			'Application File Structure - basic principles'
		]
	},
	{
		...
		technologies: [
			...
			'Responsive UI Design',
			'REST API',
			'Express JS / MERN stack basic principles',
			'JWT / Authentication and Authorization workflows - basic principles',
			'GIT',
			'Tailwind CSS',
			'TypeScript'
		]
